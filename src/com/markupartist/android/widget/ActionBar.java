...
public class ActionBar extends RelativeLayout implements OnClickListener {
    ...
    private static RelativeLayout mBarView;
    private static ImageView mLogoView;
    private static View mBackIndicator;
    //private View mHomeView;
    private static TextView mTitleView;
    private static LinearLayout mActionsView;
    private static ImageButton mHomeBtn;
            ...
            try {
               mContext.startActivity(mIntent); 
                ...
                Toast.makeText(mContext,
                        mContext.getText(R.string.error),
